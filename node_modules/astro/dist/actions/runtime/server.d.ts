...
import { deserializeActionResult, type SafeResult, type SerializedActionResult, serializeActionResult } from 'astro/actions/runtime/shared.js';
import { type ActionAPIContext, type ErrorInferenceObject, type MaybePromise } from 'astro/actions/runtime/utils.js';
export * from 'astro/actions/runtime/shared.js';
