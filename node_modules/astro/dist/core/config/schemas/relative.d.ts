...
export declare function createRelativeSchema(cmd: string, fileProtocolRoot: string): z.ZodEffects<z.ZodObject<{
    ...
    vite: z.ZodDefault<z.ZodType<import("astro").ViteUserConfig, z.ZodTypeDef, import("astro").ViteUserConfig>>;
    ...
    vite: import("astro").ViteUserConfig;
    ...
    vite?: import("astro").ViteUserConfig | undefined;
    redirects?: Record<string, string | {
        status: 301 | 302 | 303 | 307 | 308 | 300 | 304;
        destination: string;
    }> | undefined;
